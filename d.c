...
_Z(printi,prini(x,stdout);O("\n"),Ux)
_Z(pu,$(ax,prini(cat(x,tn(2,0)),stdout)){O("(");i(nx,pu(at(rx,i)));O(")");_r(x);},Ux)_Z(printt,pu(x);O("\n"),Ux)
...
ZU t(),e(U);_U(n,ti(r(s(i),i++)))_D(i2,q,';'==c[s(i)])f(E,W(-1<fi(";[(",x(n(),ix)))x=cat(x,en(e(t())));x)
